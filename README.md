...
TaskFlow is a Single Page Application (SPA) designed to help users manage their daily tasks and improve productivity. The application allows the users to create, edit, delete and track tasks efficiently and uses localstorage to store data and supports JSON import and export for data management. 
